...
/**
 * This class represents the screen used to produce the live counting report
 *
 */

public class CountReportScreen implements Initializable{
	...
	private void produceReport() {
		JFrame reportFrame = ViewLogic.countControl.produceCountReport();
